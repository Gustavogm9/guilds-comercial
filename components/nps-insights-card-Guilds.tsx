    ...
    <div className="card p-4 mb-4">
      ...
      {expandido && (
        <div className="mt-4 pt-4 border-t border-border space-y-4">
          ...
          {insights && insights.total_comentarios < 3 && (
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="text-xs space-y-1.5">
                  <p className="text-foreground/90 font-medium">
                    Análise dispõe de <strong>{insights.total_comentarios}</strong>{" "}
                    {insights.total_comentarios === 1 ? "comentário" : "comentários"} até agora.
                  </p>
                  <p className="text-muted-foreground">
                    Insights agregados (temas comuns + tom dominante) começam a aparecer com{" "}
                    <strong>3 ou mais respostas com texto</strong>. Enquanto isso, dá pra ler
                    cada resposta individual na tabela acima.
                  </p>
                  <ul className="text-muted-foreground/80 list-disc list-inside pt-1 space-y-0.5">
                    <li>Disparar mais NPS pendentes acelera a coleta</li>
                    <li>Email automático D+7 já está rodando via cron</li>
                  </ul>
                </div>
              </div>
            </div>
