...
export default function OnboardingChecklistModal({
  ...
  function handleFecharChecklist() {
    // Inline confirm dialog (não usa confirm() nativo)
    setConfirmFechar(true);
  }

  function executarFecharChecklist() {
  ...
  return (
    ...
    >
      ...
      {/* Modal de confirmação pra fechar checklist (substitui confirm() nativo) */}
      {confirmFechar && (
        <div
        ...
        >
          ...
          >
            ...
            <h3 className="text-base font-semibold text-foreground text-center" style={{ letterSpacing: "-0.24px" }}>
              Fechar checklist?
            </h3>
            <p className="text-sm text-muted-foreground text-center mt-2">
              Itens pendentes não serão exigidos. Você pode reabrir items individualmente depois.
            </p>
            <div className="flex gap-2 mt-5">
              <button onClick={() => setConfirmFechar(false)} className="btn-secondary text-sm flex-1" type="button">
                Cancelar
              </button>
              <button onClick={executarFecharChecklist} className="btn-primary text-sm flex-1" type="button">
                Fechar mesmo assim
              </button>
            </div>
          </div>
