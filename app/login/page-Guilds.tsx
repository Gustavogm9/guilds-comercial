...
function LoginForm() {
  ...
  // Lê ?error do auth callback (link expirou, etc.) e mostra antes do user tentar
  useEffect(() => {
    const errParam = searchParams.get("error");
    if (errParam && !erro) {
      const map: Record<string, string> = {
        Invalid_link: "Link inválido ou expirado. Tente acessar novamente.",
        invalid_link: "Link inválido ou expirado. Tente acessar novamente.",
      };
      setErro(map[errParam] ?? errParam.replace(/_/g, " "));
    }
