...
export default function NpsClient({
  ...
  // Branding custom — aplica cor da org se setada
  ...
  if (success) {
    return (
      <div
        className={corCustom ? "min-h-screen flex items-center justify-center p-4 relative" : "min-h-screen bg-gradient-to-br from-success-500/5 via-background to-primary/5 flex items-center justify-center p-4 relative"}
        style={bgStyle}
      >
  ...
  return (
    <div
      className={corCustom ? "min-h-screen flex items-center justify-center p-4 relative" : "min-h-screen bg-gradient-to-br from-primary/5 via-background to-primary/[0.02] flex items-center justify-center p-4 relative"}
      style={bgStyle}
    >
      <div className="absolute top-3 right-3"><ThemeToggle /></div>
