  ...
  return (
    <form action={handleSubmit} className="space-y-6">
      ...
      <fieldset className="space-y-4">
        ...
        <div>
          <label htmlFor="portal_cor_primaria" className="block text-sm font-medium text-foreground mb-1">
            Cor primária do portal <span className="text-muted-foreground font-normal">(opcional)</span>
          </label>
          <div className="flex items-center gap-2">
            <input
              id="portal_cor_primaria_picker"
              type="color"
              defaultValue={org.portal_cor_primaria ?? "#6366f1"}
              onChange={(e) => {
                const hex = document.getElementById("portal_cor_primaria") as HTMLInputElement | null;
            ...
            />
            <input
              id="portal_cor_primaria"
              name="portal_cor_primaria"
              type="text"
              defaultValue={org.portal_cor_primaria ?? ""}
              pattern="^#[0-9A-Fa-f]{6}$"
              className="input-base w-full"
              placeholder="#6366f1"
              maxLength={7}
          ...
          <p className="text-xs text-muted-foreground mt-1">
            Usada no portal embaixador e e-mails de NPS. Formato hex (ex.: <code>#6366f1</code>).
          </p>
        </div>
