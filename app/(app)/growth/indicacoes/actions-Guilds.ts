...
/**
 * Resolve pedido_id pra um lead — se já existe pedido pendente pos_fechamento, usa.
 * Caso contrário, cria um novo. Útil pro FechamentoCelebrationModal quando o
 * trigger SQL pode não ter rodado ainda ou rodou e a row já foi consumida.
 */
export async function obterOuCriarPedidoIndicacaoPosFechamento(lead_id: number): Promise<number> {
